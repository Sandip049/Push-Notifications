...
//       {!serverToken.length ? (
//         <button
//           className="mt-3 group inline-flex w-full items-center justify-center rounded-md bg-[#0d0642] px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out focus:shadow "
...
//               You already have push notifications set up on a device. You can
//               reactivate push notifications for current device using the button
//               below
//             </p>
//           </div>
//           <div className="flex justify-center">
//             <button
//               className="mt-3 group inline-flex  items-center justify-center rounded-md bg-[#0d0642] px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out focus:shadow "
//               onClick={reactivateFCMToken}
//             >
//               Re-activate push notifications
//             </button>
//           </div>
//         </>
//       )}
